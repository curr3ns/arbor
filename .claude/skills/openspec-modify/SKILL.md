...
description: Modify an existing OpenSpec change with new behavior. Use when the user wants to add, change, or remove requirements from an in-progress change and get updated artifacts and tasks ready for implementation.
license: MIT
...
**Input**: The user's modification request. Optionally specify a change name. If omitted, infer from context or prompt.
